...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Socail Login</li>
    </ul>
        ...
        <div class="col-md-12">
            <div class="tile mb-4">
                ...
                <form method="post" action="{{ route('dashboard.settings.store') }}">
                  ...
                  {{--  client secert--}}
                  <div class="form-group">
                    <label class="text-capitalize">{{$social_site}} secret id</label>
                    <input type="text" name="{{$social_site}}_secret_id" class="form-control" value="{{ setting($social_site . '_secret_id') }}">
                </div>
