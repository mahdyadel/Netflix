                ...
                var interval = setInterval(function () {
                    ...
                    $.ajax({
                        ...
                        success: function(movieWhileProcessing){
                            ...
                            $('#movie__upload-progerss').css('width' , movieWhileProcessing.percent + '%');
                            $('#movie__upload-progerss').html(movieWhileProcessing.percent + '%');
                            ...
                            if(movieWhileProcessing.percent  == 100){
                                ...
                                $('#movie__upload-progerss').parent().css('display' , 'none');
               ...
               xhr: function () {
                ...
                xhr.upload.addEventListener("progress", function (evt) {
                    if (evt.lengthComputable) {
                        ...
                        $('#movie__upload-progerss').css('width' , percentComplete).html(percentComplete);
                    }
                },false);
                   return xhr;
               },
